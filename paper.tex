...
The Fast Fourier Transform is a way of transforming a function of time into a function of frequency. It is useful when studying time-dependent phenomena. In comparison to the Discrete Fourier Transform described below, which takes $O(n^2)$ computational steps, the Fast Fourier Transform can be computed in $O(nlog(n))$ time, a considerable speedup when $n$ becomes large.\cite{WikiFFT}
...
\begin{thebibliography}{9}
	...
	\bibitem{WikiFFT}"Fast Fourier Transform." Wikipedia. Wikimedia Foundation, n.d. Web. 02 Dec. 2015.
